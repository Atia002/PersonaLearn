      ...
      <div className="hidden lg:flex items-center justify-center p-8 bg-gradient-to-br from-[#1e40af] to-[#14b8a6]">
        <div className="max-w-md space-y-6 text-white">
          <div className="space-y-4">
            <h2 className="text-4xl font-bold">Start Learning Smarter</h2>
            <p className="text-xl text-blue-100">
              Join thousands of students who are learning more effectively with personalized AI-powered education.
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div>
                <p className="font-semibold mb-1">Personalized Learning Paths</p>
                <p className="text-sm text-blue-100">Every student gets a unique path tailored to their goals and pace</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div>
                <p className="font-semibold mb-1">Hobby-Aware Examples</p>
                <p className="text-sm text-blue-100">Learn concepts through your interests - gaming, music, sports & more</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
              ...
              <div>
                <p className="font-semibold mb-1">Upload Your Materials</p>
                <p className="text-sm text-blue-100">AI tutor grounded in your class notes and study materials</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSignUp} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-center space-x-2 p-3 rounded-lg border hover:border-[#1e40af] cursor-pointer">
                ...
                <div className="flex items-center space-x-2 p-3 rounded-lg border hover:border-[#1e40af] cursor-pointer">
                  ...
                  <Label htmlFor="instructor" className="cursor-pointer flex-1">
                    Instructor
                  </Label>
                </div>
                <div className="flex items-center space-x-2 p-3 rounded-lg border hover:border-[#1e40af] cursor-pointer">
